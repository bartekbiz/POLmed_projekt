			...
			trlekarze.innerHTML += '<div class="col-md-4 p-3"> \
				<div class="card"> \
					<div class="card-body"> \
						...
						<h6 class="card-subtitle mb-2 text-muted">' + data.lekarze[i].profession + '</h6> \
						<p class="card-text">' + data.lekarze[i].desc + '</p> \
						<a href="booking.html?id=' + data.lekarze[i].id + '" class="btn btn-primary w-100">Zarezerwuj wizytę</a> \
					</div> \
				</div> \
			</div>';
		}
			...
			trpolozne.innerHTML += '<div class="col-md-4 p-3"> \
				<div class="card"> \
					<div class="card-body"> \
						...
						<h6 class="card-subtitle mb-2 text-muted">' + data.polozne[i].profession + '</h6> \
						<p class="card-text">' + data.polozne[i].desc + '</p> \
						<a href="booking.html?id=' + data.polozne[i].id + '" class="btn btn-primary w-100">Zarezerwuj wizytę</a> \
					</div> \
				</div> \
			</div>';
		}
			...
			trpielegniarze.innerHTML += '<div class="col-md-4 p-3"> \
				<div class="card"> \
					<div class="card-body"> \
						...
						<h6 class="card-subtitle mb-2 text-muted">' + data.pielegniarze[i].profession + '</h6> \
						<p class="card-text">' + data.pielegniarze[i].desc + '</p> \
						<a href="booking.html?id=' + data.pielegniarze[i].id + '" class="btn btn-primary w-100">Zarezerwuj wizytę</a> \
					</div> \
				</div> \
			</div>';
		}
